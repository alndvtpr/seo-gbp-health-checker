...
const resume = read('src/components/ResumePdfPreview.tsx')
const gbp = read('src/components/GBPHealthChecker.tsx')
const emailDialog = read('src/components/gbp/EmailReportDialog.tsx')
const projects = read('src/components/ProjectsDirectory.tsx')
const credentials = read('src/components/AboutCredentials.tsx')
