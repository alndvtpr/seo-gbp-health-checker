          ...
          {[
            {
              ...
              price: 'from ₱3,500 PHP',
              subPrice: 'approx. $65 USD • Up to 15 pages',
              desc: 'Technical crawl diagnostics, Core Web Vitals profiling, robots/sitemap inspection, and prioritized action plan.',
              badge: 'Evaluation',
              href: '/tools/#website-audit',
              btnLabel: 'Request Audit',
            },
            {
              title: 'Technical SEO Sprint',
              price: 'from ₱8,500 PHP',
              subPrice: 'approx. $155 USD • Up to 10 fixes',
              desc: '1-week sprint fixing indexing issues, 404s, redirect chains, robots/sitemaps in GSC, and JSON-LD schema.',
              badge: 'Foundation Sprint',
              href: '/contact/?service=Technical%20SEO%20Audit',
              btnLabel: 'Book Sprint',
            },
            {
              title: 'On-Page SEO Sprint',
              price: 'from ₱6,500 PHP',
              subPrice: 'approx. $120 USD • Up to 5 pages',
              desc: 'Search intent keyword mapping, single-H1 heading restructuring, click-focused metadata, and internal linking.',
            ...
            },
            {
              ...
              price: 'from ₱7,500 PHP',
              subPrice: 'approx. $135 USD • 1 GBP location',
              desc: '10-point Google Business Profile calibration, category alignment, NAP consistency review, and local schema.',
              badge: 'Visibility Sprint',
              href: '/contact/?service=Local%20SEO%20Optimization',
              btnLabel: 'Book Local SEO',
            },
          ].map((pkg, idx) => (
            <div
              key={pkg.title}
