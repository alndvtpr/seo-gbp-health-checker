...
export default async function Page() {
  ...
  return (
    <>
      ...
      <section className="py-10 sm:py-14 bg-[#0e1010] border-y border-white/[0.06] relative z-20 overflow-hidden">
        {/* Subtle Background Glow Radial Accent */}
        <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(ellipse_at_center,rgba(230,126,34,0.05)_0%,transparent_70%)]" />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center mb-6 sm:mb-8 relative z-10">
        ...
        <div 
          className="w-full relative flex flex-col gap-3 sm:gap-4 py-1"
          style={{ 
          ...
          <div className="flex w-[200%] animate-marquee-left marquee-row">
            <div className="flex flex-nowrap w-1/2 justify-around items-center gap-2.5 sm:gap-3.5 px-2">
              {[
                ...
                { name: 'JavaScript', svg: <svg viewBox="0 0 24 24" fill="#F7DF1E" className="w-full h-full"><path d="M0 0h24v24H0z" fill="none"/><path d="M1.5 1.5h21v21h-21z" fill="#f7df1e"/><path d="M11.8 17.5c.4.7 1.1 1.2 2.1 1.2 1.3 0 1.9-.6 1.9-2.1v-6.7h2.8v6.7c0 3-1.8 4.5-4.6 4.5-2.5 0-3.9-1.3-4.6-2.7l2.4-1.4zm-7.6-1.4c.5 1 1.6 1.7 3.2 1.7 1.4 0 2.3-.7 2.3-1.6 0-1.1-.9-1.5-2.5-2.1l-.9-.4c-2.5-1-4-2.2-4-4.9 0-2.7 2.1-4.7 5.3-4.7 2.5 0 4.1.9 5 2.6l-2.4 1.5c-.5-.9-1.3-1.4-2.5-1.4-1.1 0-1.9.6-1.9 1.5 0 .9.6 1.3 2.1 1.9l.9.4c2.9 1.2 4.4 2.3 4.4 5.1 0 3.1-2.4 4.8-5.8 4.8-3.1 0-5.1-1.5-5.9-3.2l2.7-1.2z" fill="#000"/></svg> },
                ...
                { name: 'Payload CMS', svg: <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full text-white"><path d="M12 2L1 22h22L12 2zm0 3.8l8.2 14.8H3.8L12 5.8zM12 9l-4 7h8l-4-7z"/></svg> },
                ...
                <div
                  key={`${tool.name}-1-${idx}`}
                  title={tool.name}
                  className="w-[42px] h-[42px] sm:w-[48px] sm:h-[48px] p-2.5 sm:p-3 rounded-xl bg-[#161819] border border-white/[0.07] shadow-sm hover:border-primary-container/60 hover:bg-[#1d2022] hover:-translate-y-1 transition-all duration-300 group flex items-center justify-center shrink-0"
                >
                  <div className="w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center drop-shadow-[0_0_6px_rgba(255,255,255,0.08)] group-hover:drop-shadow-[0_0_10px_currentColor]">
                    {tool.svg}
                  </div>
                </div>
              ))}
