        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <a 
              ...
              className="bg-white/5 border border-white/10 text-on-surface font-heading text-xs uppercase tracking-widest font-bold px-6 py-3.5 rounded-xl hover:bg-white/10 transition-all duration-300 flex items-center gap-2"
            >
