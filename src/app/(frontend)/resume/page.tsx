...
const CERTIFICATIONS: CertificationItem[] = [
  {
    title: 'SEO Bootcamp Completion',
    issuer: 'Pinoy SEO & SOVA Training (Batch 32)',
...
export default function ResumePage() {
  return (
    <div className="pt-28 sm:pt-36 pb-16 sm:pb-24 px-4 sm:px-6 md:px-12 lg:px-16 max-w-4xl mx-auto relative z-20 space-y-10 sm:space-y-14">
      ...
      <header className="bg-surface-1 rounded-2xl sm:rounded-3xl border border-black/10 dark:border-white/10 p-6 sm:p-8 md:p-10 shadow-sm relative overflow-hidden motion-reveal">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6 pb-6 border-b border-black/10 dark:border-white/10">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11px] font-heading font-semibold bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 uppercase tracking-[0.06em]">
        ...
        <div className="pt-5 flex flex-wrap items-center gap-2 sm:gap-2.5">
          <a
            ...
            className="h-8 px-3 inline-flex items-center gap-1.5 rounded-full bg-surface-2 hover:bg-black/5 dark:hover:bg-white/10 text-xs font-sans text-on-surface/85 hover:text-primary-container transition-colors border border-black/5 dark:border-white/5"
          >
      ...
      {/* Education & Verified Certifications (Balanced 2-Column Grid) */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 motion-reveal">
        {/* Education */}
        <section className="space-y-3" aria-labelledby="education-heading">
          <div className="flex items-center gap-2">
            <Icon name="school" size={18} className="text-primary-container" />
            <h2 id="education-heading" className="font-heading text-lg font-bold text-on-surface tracking-tight">
              Education
            </h2>
          </div>
          ...
          <div className="space-y-3">
            <div className="bg-surface-1 rounded-2xl border border-black/10 dark:border-white/10 p-5 space-y-1.5 shadow-xs">
              <div className="flex items-center justify-between gap-2">
                <span className="text-[10px] font-heading font-bold uppercase tracking-wider px-2 py-0.5 rounded bg-emerald-500/10 text-emerald-500 border border-emerald-500/20">
                  Ongoing Degree
                </span>
            ...
            <div className="bg-surface-1 rounded-2xl border border-black/10 dark:border-white/10 p-5 space-y-1.5 shadow-xs">
              <div className="flex items-center justify-between gap-2">
                <span className="text-[10px] font-heading font-bold uppercase tracking-wider px-2 py-0.5 rounded bg-surface-2 text-on-surface/70 border border-black/5 dark:border-white/5">
                  Undergraduate
                </span>
                <span className="text-xs font-sans text-on-surface/60">2014 – 2017</span>
              </div>
              <h3 className="font-heading text-sm font-bold text-on-surface pt-1">
        ...
        {/* Certifications */}
        <section className="space-y-3" aria-labelledby="certifications-heading">
          <div className="flex items-center gap-2">
            <Icon name="verified" size={18} className="text-primary-container" />
            <h2 id="certifications-heading" className="font-heading text-lg font-bold text-on-surface tracking-tight">
              Certifications
            </h2>
          </div>
          ...
          <div className="space-y-2.5">
            {CERTIFICATIONS.map((cert) => (
              <div
                key={cert.title}
                className="bg-surface-1 rounded-2xl border border-black/10 dark:border-white/10 p-4 space-y-1 shadow-xs"
              >
                <div className="flex items-center justify-between gap-2">
                  <h3 className="font-heading text-xs font-bold text-on-surface">
                    {cert.title}
                  </h3>
                  <span className="text-[10px] font-heading font-medium px-2 py-0.5 rounded-full bg-surface-2 text-on-surface/70 border border-black/5 dark:border-white/5 shrink-0">
                    {cert.badge}
                  </span>
                </div>
                ...
                {cert.verifyUrl && (
                  <div className="pt-1">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1 text-[11px] font-heading font-semibold text-emerald-500 hover:text-emerald-400 transition-colors"
                    >
