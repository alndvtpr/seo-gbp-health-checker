...
- [Resume & Professional Credentials](https://www.alaintapiru.com/resume/): Web resume, work experience timeline, technology matrix, and downloadable PDF resume.
- [SEO & Web Services Hub](https://www.alaintapiru.com/services/): Practical SEO and web support, approved starting packages, and clear scope boundaries.
...
- [SEO-Ready Web Development](https://www.alaintapiru.com/services/web-development/): Code-first Next.js builds and custom WordPress themes with layout-stability safeguards.
- [Portfolio & Project Breakdowns](https://www.alaintapiru.com/projects/): Three self-initiated builds with exact roles, implementation details, and evidence limits.
...
- [Full Machine-Readable Profile](https://www.alaintapiru.com/llms-full.txt): Background, methods, architecture details, and project evidence boundaries.
`
