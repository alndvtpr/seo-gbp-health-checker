...
export function GbpCheckerCard() {
  return (
    <div
      ...
      className="p-5 sm:p-8 rounded-2xl sm:rounded-3xl bg-surface-1/95 border border-black/10 dark:border-white/10 space-y-4 sm:space-y-6 motion-reveal shadow-sm scroll-mt-28"
    >
      <div className="flex items-center justify-between">
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-on-surface/80 hover:text-on-surface hover:bg-black/10 dark:hover:bg-white/10 text-xs font-heading font-medium transition-colors"
        >
