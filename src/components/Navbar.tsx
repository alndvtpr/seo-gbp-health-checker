        ...
        >
          ...
          <div className="hidden md:flex items-center gap-4 relative z-[60]">
            ...
            <div className="flex items-center gap-3 mr-1 pr-5 border-r border-white/10">
              ...
              {/* Facebook */}
              <a href="https://facebook.com/dcrazedave" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full bg-primary-container/10 text-primary-container hover:bg-primary-container hover:text-on-primary-container transition-all animate-brand-ripple" title="Facebook">
      ...
      >
        ...
        <nav className="flex flex-col items-center gap-5 sm:gap-6 relative z-10 w-full px-6 max-w-sm">
          ...
          <div className="flex gap-4 mt-6">
            ...
            <a href="https://github.com/alndvtpr" target="_blank" rel="noopener noreferrer" className="w-12 h-12 flex items-center justify-center rounded-full bg-primary-container/10 text-primary-container hover:bg-primary-container hover:text-on-primary-container transition-all animate-brand-ripple">
