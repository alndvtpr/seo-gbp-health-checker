...
export const MobileMenu = ({
  ...
  return (
    <div
      ...
      className="fixed inset-0 bg-background/98 dark:bg-[#0c0f0f]/98 z-[55] flex flex-col justify-center items-center xl:hidden opacity-100 pointer-events-auto translate-y-0 mobile-menu-active"
      style={{
    ...
    >
      ...
      <nav aria-label="Mobile navigation" className="flex flex-col items-center gap-2 text-center z-10 w-full px-5 max-w-sm max-h-[calc(100dvh-120px)] overflow-y-auto">
        ...
        {/* Social links and theme control */}
        <div
          role="group"
        ...
        >
          ...
          <a
            ...
            className="w-11 h-11 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-full bg-black/5 dark:bg-white/5 border border-primary-container/30 text-primary-container hover:bg-primary-container hover:text-on-primary-container transition-colors"
            aria-label="Gmail"
            title="Gmail"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20" aria-hidden="true" focusable="false" className="shrink-0">
          ...
          <a
            ...
            title="LinkedIn"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18" aria-hidden="true" focusable="false" className="shrink-0">
