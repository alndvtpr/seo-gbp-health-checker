  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6">
        ...
        <article className="lg:col-span-7 p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl bg-[#181a1b]/90 border border-white/5 hover:border-primary-container/40 transition-all duration-300 group flex flex-col justify-between shadow-lg">
          <div>
            <div className="flex items-center justify-between gap-2 mb-6">
              ...
              <span className="text-[11px] font-heading font-semibold uppercase tracking-wider text-on-surface/60 px-3 py-1 rounded-full bg-white/5 border border-white/10">
                Pillar 03 • Web Dev
              </span>
            </div>
            ...
            <div className="space-y-3 pt-6 border-t border-white/10 mb-8">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 font-sans text-xs sm:text-sm text-on-surface/85">
        ...
        <article className="lg:col-span-5 p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl bg-[#181a1b]/90 border border-white/5 hover:border-primary-container/40 transition-all duration-300 group flex flex-col justify-between shadow-lg">
          <div>
            <div className="flex items-center justify-between gap-2 mb-6">
              <div className="w-12 h-12 rounded-xl bg-primary-container/10 border border-primary-container/20 flex items-center justify-center group-hover:scale-105 transition-all">
        ...
        <article className="md:col-span-2 lg:col-span-12 p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl bg-gradient-to-r from-primary-container/10 via-[#181a1b] to-[#181a1b] border border-white/5 hover:border-primary-container/40 transition-all duration-300 group flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 shadow-lg">
          <div className="lg:max-w-2xl">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 font-sans text-xs sm:text-sm text-on-surface/85 pt-4 border-t border-white/10">
              <li className="flex items-start gap-2.5">
                <Icon name="check_circle" size={16} className="text-primary-container shrink-0 mt-0.5" />
