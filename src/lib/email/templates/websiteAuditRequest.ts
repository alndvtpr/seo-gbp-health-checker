import type { WebsiteAuditRequestData } from '@/lib/schemas/audit-request'

export function generateOwnerAlertHtml(data: WebsiteAuditRequestData, dateStr: string): string {
...
export function generateOwnerAlertText(data: WebsiteAuditRequestData, dateStr: string): string {
  const { website, email, name, focus, notes } = data
...
export function generateRequesterConfirmationHtml(data: WebsiteAuditRequestData, dateStr: string): string {
...
export function generateRequesterConfirmationText(data: WebsiteAuditRequestData, dateStr: string): string {
  const { website, name } = data
  const greeting = name ? `Hi ${name.trim()},` : 'Hello,'
